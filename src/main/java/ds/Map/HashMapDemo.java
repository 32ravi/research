...
public class HashMapDemo {
	...
	public static void main(String[] args) 
    {
        ...
        //====NOTE=====>>> HashMap can have one null key and multiple null values
        ...
        System.out.println("Size Of The Map : "+map.size()); //7
        ...
        System.out.println("Another way to print map :" + map);
        System.out.println("-----------------");
