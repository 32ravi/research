...
public class ReflectionExample {
	...
	public static void main(String[] args) {
		...
		Class classObject = RentCar.class;
		try {
			// get the absolute name of the class
			String rentalClassPackage = classObject.getName();
			System.out.println("Fully qualified Class Name is: " + rentalClassPackage);

			// get the simple name of the class (without package info)
			String rentalClassNoPackage = classObject.getSimpleName();
			System.out.println("Class Name without package is: " + rentalClassNoPackage);

			// get the package name of the class
			Package rentalPackage = classObject.getPackage();
			...
			Constructor constructor = classObject.getConstructor(Integer.TYPE);
			...
			Method[] allmethods = classObject.getMethods();
			...
			System.out.println("");//to keep output clean
			// get method with specific name and parameters
			Method oneMethod = classObject.getMethod("computeRentalCost", new Class[] { Integer.TYPE });
			...
			for (Field oneField : fields) {
				...
				Field field = classObject.getField(oneField.getName());
			...
			Field privateField = RentCar.class.getDeclaredField("carType");

			String name = privateField.getName();
			System.out.println("One private Fieldname is: " + name);
		
			// RSN NOTE:make this private field instance accessible for reflection use only, not normal code
			privateField.setAccessible(true); //RSN NOTE : similar technique is used to create Unsafe Object
